...
export const defaultLinkedInSlides: LinkedInSlide[] = [
  {
    ...
    imagePathJpeg: assetPath('/media/linkedin/graduation/slide-1.jpeg'),
    imagePathJpg: assetPath('/media/linkedin/graduation/slide-1.jpg'),
    imagePathPng: assetPath('/media/linkedin/graduation/slide-1.png'),
    imagePathWebp: assetPath('/media/linkedin/graduation/slide-1.webp'),
  ...
  },
  {
    ...
    imagePathJpeg: assetPath('/media/linkedin/graduation/slide-2.jpeg'),
    imagePathJpg: assetPath('/media/linkedin/graduation/slide-2.jpg'),
    imagePathPng: assetPath('/media/linkedin/graduation/slide-2.png'),
    imagePathWebp: assetPath('/media/linkedin/graduation/slide-2.webp'),
  ...
  },
  {
    ...
    imagePathJpeg: assetPath('/media/linkedin/graduation/slide-3.jpeg'),
    imagePathJpg: assetPath('/media/linkedin/graduation/slide-3.jpg'),
    imagePathPng: assetPath('/media/linkedin/graduation/slide-3.png'),
    imagePathWebp: assetPath('/media/linkedin/graduation/slide-3.webp'),
