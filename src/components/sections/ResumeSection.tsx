...
export const ResumeSection: React.FC = () => {
  ...
  const handleDownload = () => {
    setDownloaded(true);
    // Create and trigger structured downloadable text/markdown resume or trigger print
    const resumeText = `# ${profileData.name} — Resume
Email: ${profileData.email} | Location: ${profileData.location}
GitHub: ${profileData.githubUrl} | LinkedIn: ${profileData.linkedinUrl}
...
* ${t.resume.educationDetails.degree}
  ${t.resume.educationDetails.institution} (${t.resume.educationDetails.period})
...
HONORS & AWARDS
=======================================================
${t.resume.honors.map((h) => `* ${h.title} — ${h.issuer} (${h.date})\n  ${h.desc}`).join('\n')}

=======================================================
RESEARCH
=======================================================
* ${t.resume.researchDetails.title} (${t.resume.researchDetails.date})
...
CERTIFICATIONS
=======================================================
${t.resume.certifications.map((c) => `* ${c.name} (${c.issuer}, ${c.date})`).join('\n')}

=======================================================
LANGUAGES
=======================================================
${t.resume.languagesList.map((l) => `* ${l.lang}: ${l.level}`).join('\n')}
`;
    ...
    link.href = url;
    link.download = `Elham-Rivaz-Resume-${language.toUpperCase()}.md`;
