    ...
    <section id="contact" className="py-20 lg:py-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-[#0F1115] dark:text-white tracking-tight mb-3">
            {t.contact.title}
          </h2>
          <p className="text-sm sm:text-base text-[#272A30] dark:text-neutral-400 font-medium">
            {t.contact.subtitle}
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="glass-panel p-6 rounded-2xl">
              ...
              <p className="font-mono text-sm sm:text-base font-bold text-[#0F1115] dark:text-white mb-4 select-all">
                {profileData.email}
              </p>
            ...
            <div className="glass-panel p-6 rounded-2xl">
              ...
              <p className="font-display text-sm sm:text-base font-bold text-[#0F1115] dark:text-white mb-1">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                ...
                className="glass-panel p-4 rounded-xl flex items-center justify-between text-[#0F1115] dark:text-neutral-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors group"
              >
            ...
            <WindowChrome title={t.contact.cardPrompt} className="shadow-lg">
              <form onSubmit={handleFormSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-mono text-[#0F1115] dark:text-neutral-400 mb-1.5 font-bold">
                      Your Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-black/[0.03] dark:bg-white/[0.04] border border-black/15 dark:border-white/10 text-sm text-[#0F1115] dark:text-white placeholder:text-neutral-500 dark:placeholder:text-white/25 focus:outline-none focus:border-indigo-500 dark:focus:border-white/30 backdrop-blur-sm transition-colors font-medium"
                    />
                  </div>

                  <div>
                    <label className="block text-xs font-mono text-[#0F1115] dark:text-white/50 mb-1.5 font-bold">
                      Your Email
                    </label>
                    <input
                      type="email"
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <Button
                    ...
                    variant="primary"
                    size="md"
                    icon={messageSent ? <Check className="w-4 h-4" /> : <Send className="w-4 h-4" />}
                  >
